...
//Name: simple door.ma
//Last modified: Mon, Mar 17, 2014 04:05:37 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.9050150688627752 3.4264070639878406 4.266639113624354 ;
	setAttr ".r" -type "double3" -28.538352729603137 39.000000000000568 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 6.4500347606985207;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" 0 0 0.13622689334663629 ;
...
createNode mesh -n "pCubeShape3" -p "transform1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt[0:7]" -type "float3"  0 0 0.37712672 0 0 0.37712672 
		0 0 0.37712672 0 0 0.37712672 0 0 -0.37712672 0 0 -0.37712672 0 0 -0.37712672 0 0 
		-0.37712672;
	setAttr -s 8 ".vt[0:7]"  -1.5 -2.5 0.1 1.5 -2.5 0.1 -1.5 2.5 0.1 1.5 2.5 0.1
		 -1.5 2.5 -0.1 1.5 2.5 -0.1 -1.5 -2.5 -0.1 1.5 -2.5 -0.1;
...
createNode transform -n "pSphere1";
	setAttr ".t" -type "double3" 1.1534715553951485 0 0.29458532556536199 ;
	setAttr ".s" -type "double3" 0.13818102445783853 0.13818102445783853 0.13818102445783853 ;
